...
function UsageStatistics() {
    return (
        <div className='main-container flex w-[437px] h-[258px] pt-[30px] pr-0 pb-[20px] pl-0 flex-col gap-[16px] items-center flex-nowrap bg-[#fff] rounded-[8px] border-solid border border-[#d8dbdf] relative mx-auto my-0'>
            <div className='flex w-[437px] h-[30px] flex-col gap-[-12px] justify-center items-center shrink-0 flex-nowrap '>
            ...
            <div className='flex w-[397px] h-[23px] gap-[20px] items-center shrink-0 flex-nowrap  z-[5]'>
            ...
            <div className='flex w-[397px] h-[23px] flex-col gap-[4px] items-start shrink-0 flex-nowrap z-[11]'>
            ...
            <div className='main-container flex w-[119px] h-[36px] pt-[5px] pr-[10px] pb-[5px] pl-[10px] gap-[8px] justify-center items-center flex-nowrap bg-[#fcedb9] rounded-[37px] relative my-0' style={{ marginRight: "auto", marginLeft: "22px" }}>
            ...
            <p className="usage_statistics h-[30px] ml-[22px] font-['SF_Pro_Display'] text-[12px] font-medium leading-[15px] text-[#232934] relative mx-auto my-0">Upgrade to a higher plan to unlock more SKUs for Virtual Try-On and to create more product photos</p>
