    ...
    <div className="self-stretch second_header">
      <div className="flex gap-5 max-md:flex-col max-md:gap-0">
        <div className='flex w-[768px] flex-col gap-[32px] items-start shrink-0 flex-nowrap relative'>
          ...
          <div className='main-container flex w-[768px] flex-col gap-[32px] items-start flex-nowrap relative mx-auto my-0'>
            ...
            <div className='flex h-[481px] flex-col gap-[20px] items-start self-stretch shrink-0 flex-nowrap relative z-[3]'>
              <div className='flex pt-[8px] pr-0 pb-[8px] pl-0 flex-col gap-[24px] justify-center items-start self-stretch shrink-0 flex-nowrap relative z-[4]'>
                <div className='flex w-[578px] h-[115px] flex-col gap-[16px] items-start shrink-0 flex-nowrap relative z-[5]'>
                  ...
                  <div className='w-[174px] h-[36px] shrink-0 rounded-[100px] absolute top-[136px] left-0 z-[26]'>
              ...
              <div className='flex w-[159px] h-[177px] flex-col items-start shrink-0 flex-nowrap bg-[#fff] rounded-[12px] absolute top-[189px] left-[47px] overflow-hidden shadow-[0_1px_0_0_rgba(26,26,26,0.07)] z-[34]'>
              ...
              <div className='flex w-[159px] h-[177px] flex-col items-start shrink-0 flex-nowrap bg-[#fff] rounded-[12px] absolute top-[189px] left-[233px] overflow-hidden shadow-[0_1px_0_0_rgba(26,26,26,0.07)] z-[42]'>
              ...
              <div className='flex w-[159px] h-[177px] flex-col items-start shrink-0 flex-nowrap bg-[#fff] rounded-[12px] absolute top-[189px] left-[419px] overflow-hidden shadow-[0_1px_0_0_rgba(26,26,26,0.07)] z-50'>
              ...
              <div className='w-[226px] h-[36px] shrink-0 rounded-[100px] absolute top-[386px] left-0 z-[58]'>
              ...
              <div className='w-[165px] h-[36px] shrink-0 rounded-[100px] absolute top-[438px] left-0 z-[62]'>
              ...
              <div className='w-px h-[186px] shrink-0 bg-[url(../assets/images/6ccf0c05-ce59-4646-8ad4-ad42025c274a.png)] bg-cover bg-no-repeat absolute top-[180px] left-[17px] z-[66]' style={{background: "black"}}/>

              <div className='flex w-[236px] h-[44px] gap-[20px] items-start shrink-0 flex-nowrap absolute top-[498px] left-0 z-[82]'>
                <button className='flex w-[82px] justify-center items-end shrink-0 flex-nowrap border-none relative z-[83] pointer'>
                  <div className='flex w-[82px] pt-[10px] pr-[18px] pb-[10px] pl-[18px] gap-[8px] justify-center items-center shrink-0 flex-nowrap bg-[#047ac6] rounded-[999px] relative overflow-hidden z-[84]'>
                    <span className="h-[24px] shrink-0 basis-auto font-['SF_Pro_Display'] text-[16px] font-medium leading-[24px] text-[#fff] relative text-left whitespace-nowrap z-[85]">
                      Next
