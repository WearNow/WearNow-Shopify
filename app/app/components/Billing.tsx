...
function Billing() {
  return (
    ...
    <div className='flex w-[316px] h-[52px] pt-[4px] pr-[4px] pb-[4px] pl-[4px] gap-[8px] items-start shrink-0 flex-nowrap bg-[rgba(116,116,128,0.08)] rounded-[100px] absolute top-[153px]  z-[3]'>
      <button className='flex w-[150px] pt-[10px] pr-[10px] pb-[10px] pl-[10px] gap-[4px] justify-center items-center shrink-0 flex-nowrap bg-[#1d2127] rounded-[100px] border-none relative z-[4] pointer'>
      ...
      <div className='flex w-[150px] pt-[10px] pr-[10px] pb-[10px] pl-[10px] gap-[4px] justify-center items-baseline shrink-0 flex-nowrap rounded-[100px] relative z-[6]'>
  ...
  <div className='main-container flex w-[1244px] h-[546px] gap-px items-end flex-nowrap rounded-[16px] border-solid border border-[#e0e0e0]  overflow-hidden mx-auto my-0'>
