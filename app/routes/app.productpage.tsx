  ...
  return (
    <>
      ...
      <div className="product_page_container">
        ...
        <section className="container mx-auto mt-6 product_page_table_content" style={{ maxWidth: "100%" }}>
              ...
              <div className="inline-block w-full align-middle lg:px-[36px]">
                <div className="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg" style={{ borderColor: "rgb(208 209 211)" }}>
                  <table className="product_page_table w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead className="bg-gray-50 dark:bg-gray-800" style={{ background: "#FFFFFF", borderBottom: "1px solid #bebcbf" }}>
                      <tr>
                        <th scope="col" className="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                          <div className="flex items-center gap-x-3" style={{gap:"64px"}}>
                            <Checkbox
                              label=""
                              checked={checked}
                    ...
                    <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900" style={{ background: "#fffcfc" }}>
                      <tr style={{ background: "#FFFFFF", borderTop: "1px solid #bebcbf" }}>
                        <td className="px-4 py-4 text-sm font-medium text-gray-700 dark:text-gray-200 whitespace-nowrap">
                          <div className="inline-flex items-center gap-x-3">
                            ...
                            <div className="flex items-center gap-x-2">
                              ...
                              <div>
                                <h2 className="text-sm font-medium text-gray-800 dark:text-black product_title_table">[Product Name]</h2>
                              </div>
                            </div>
                          </div>
                        </td>
                        ...
                        <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap"style={{position:"relative",zIndex:"0"}}>
                          <TextField
                            label=""
                            type="number"
                            value={value}
