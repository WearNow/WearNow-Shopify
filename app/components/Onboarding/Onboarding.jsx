  ...
  return (
    <>
      <div className="container w-full	h-80 m-auto mt-2 px-4" style={{ maxWidth: "90%" }}>
        <h1 className="mb-2 onbording_step_title">Onboarding - 1 of 2 steps</h1>
        <div className="relative flex rounded-full overflow-hidden onboarding_steps" style={{ gap: "2px",height:"4.3px" }}>
          <button className='onbording_step_first'></button>
          <button className='onbording_step_second'></button>
        </div>
        <div className="flex gap-10	mt-10 mb-10">
          <div className="onboarding_left" style={{ width: "70%" }}>
            ...
            <div className='onboarding_opacity_content'>
              ...
              <div className="buton_content mt-5 flex gap-10 items-center">
                <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-3 rounded-full flex gap-2 items-center">
                  Continue
