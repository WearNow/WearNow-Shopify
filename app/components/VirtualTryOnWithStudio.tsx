            ...
            <button className='w-[94px] h-[24px] shrink-0 border-none relative z-[5] pointer'>
              <div className='w-[94px] h-[24px] absolute top-0 left-0 z-[6]'>
                <div className='w-full h-full text-[0px] absolute top-0 left-0 overflow-hidden z-[7]'>
                  <span className="flex w-[90.385px] h-[16px] justify-center items-start font-['SF_Pro_Text'] text-[12px] font-normal leading-[16px] text-[#006dbc] relative text-center whitespace-nowrap z-[9] mt-[3.5px] mr-0 mb-0 ml-0">
                    Coming Soon
                  </span>
