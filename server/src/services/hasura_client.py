...
class Client:
    ...
    def create_prod_request(self, store_id, model_id, store_pid, bgid, public_state): return self.run_query(
        """
        ...
        """, {"store_id": store_id,  "model_id": model_id, "background_id": bgid, "store_product_id": store_pid, "public": public_state}
    )
