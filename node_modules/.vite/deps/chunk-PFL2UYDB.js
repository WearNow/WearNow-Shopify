...
var DEFAULT_CONTENT_TYPE, DEFAULT_SDK_VARIANT, DEFAULT_CLIENT_VERSION, PUBLIC_ACCESS_TOKEN_HEADER, PRIVATE_ACCESS_TOKEN_HEADER, SDK_VARIANT_HEADER, SDK_VERSION_HEADER, SDK_VARIANT_SOURCE_HEADER, CLIENT;
var init_constants = __esm({
  "node_modules/@shopify/storefront-api-client/dist/constants.mjs"() {
    DEFAULT_CONTENT_TYPE = "application/json";
    DEFAULT_SDK_VARIANT = "storefront-api-client";
    DEFAULT_CLIENT_VERSION = "0.3.4";
...
var normalizeSecretKey, privCache, pubCache, isKeyObject, importAndCache, normalizePublicKey, normalizePrivateKey, normalize_key_default;
var init_normalize_key = __esm({
  "node_modules/jose/dist/browser/runtime/normalize_key.js"() {
    init_base64url();
    init_jwk_to_key();
    normalizeSecretKey = (k) => decode(k);
    isKeyObject = (key) => {
      return (key == null ? void 0 : key[Symbol.toStringTag]) === "KeyObject";
    };
    importAndCache = async (cache, key, jwk, alg) => {
...
var tag, symmetricTypeCheck, asymmetricTypeCheck, checkKeyType, check_key_type_default;
var init_check_key_type = __esm({
  "node_modules/jose/dist/browser/lib/check_key_type.js"() {
    init_invalid_key_input();
    init_is_key_like();
    tag = (key) => key == null ? void 0 : key[Symbol.toStringTag];
...
var USER_AGENT, _a, _b, experimental_jwksCache, RemoteJWKSet;
  ...
  "node_modules/jose/dist/browser/jwks/remote.js"() {
    ...
    RemoteJWKSet = class {
      constructor(url, options) {
        ...
        if ((options == null ? void 0 : options[experimental_jwksCache]) !== void 0) {
          this._cache = options == null ? void 0 : options[experimental_jwksCache];
          if (isFreshJwksCache(options == null ? void 0 : options[experimental_jwksCache], this._cacheMaxAge)) {
...
//# sourceMappingURL=chunk-PFL2UYDB.js.map
