...
var Trie2 = class _Trie {
  ...
  mapFor(key, create) {
    return this.weakness && isObjRef2(key) ? this.weak || (create ? this.weak = /* @__PURE__ */ new WeakMap() : void 0) : this.strong || (create ? this.strong = /* @__PURE__ */ new Map() : void 0);
  }
};
...
var DocumentTransform = (
  ...
  function() {
    ...
    DocumentTransform2.prototype.resetCache = function() {
      var _this = this;
      if (this.cached) {
        var stableCacheKeys_1 = new Trie2(canUseWeakMap);
...
var ApolloCache = (
  ...
  function() {
    ...
    ApolloCache2.prototype.watchFragment = function(options) {
      var _this = this;
      var fragment = options.fragment, fragmentName = options.fragmentName, from = options.from, _a2 = options.optimistic, optimistic = _a2 === void 0 ? true : _a2;
...
//# sourceMappingURL=chunk-BL54Y2I5.js.map
