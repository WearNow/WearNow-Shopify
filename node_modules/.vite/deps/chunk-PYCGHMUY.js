...
// node_modules/@remix-run/react/node_modules/@remix-run/server-runtime/dist/esm/formData.js
init_src();
...
function createRouter3(init) {
  ...
  async function handleFetcherAction(key, routeId, path, match, requestMatches, isFogOfWar, flushSync, submission) {
    ...
    if (redirect6) {
      ...
      return startRedirectNavigation(revalidationRequest, redirect6.result);
    }
    let {
      loaderData,
      errors
  ...
  async function startRedirectNavigation(request, redirect6, _temp2) {
    let {
      submission,
      fetcherSubmission,
      replace
...
function patchRoutesImpl(routeId, children, routesToUse, manifest, mapRouteProperties2) {
  if (routeId) {
    ...
    let dataChildren = convertRoutesToDataRoutes2(children, mapRouteProperties2, ["patch", String(routesToUse.length || "0")], manifest);
...
async function callDataStrategyImpl(dataStrategyImpl, type, request, matchesToLoad, matches, manifest, mapRouteProperties2, requestContext) {
  ...
  matches.forEach((m) => invariant3(loadedMatches.has(m.route.id), '`match.resolve()` was not called for route id "' + m.route.id + '". You must call `match.resolve()` on every match passed to `dataStrategy` to ensure all routes are properly loaded.'));
...
async function convertHandlerResultToDataResult(handlerResult) {
  ...
  if (type === ResultType3.error) {
    return {
      type: ResultType3.error,
      error: result,
      statusCode: isRouteErrorResponse3(result) ? result.status : status
    };
  }
...
var json4 = (data, init = {}) => {
  return json2(data, init);
};
var defer4 = (data, init = {}) => {
  return defer2(data, init);
};
  ...
  return decode(body, {
    plugins: [(type, ...rest) => {
      ...
      if (type === "ErrorResponse") {
        ...
        return {
          value: new ErrorResponseImpl2(status, statusText, data)
        };
      }
...
function unwrapSingleFetchResult(result, routeId) {
  if ("error" in result) {
    ...
    return redirect3(result.redirect, {
...
function PrefetchPageLinksImpl({
  ...
  if (!future.unstable_singleFetch) {
    linksToRender = dataHrefs.map((href) => React8.createElement("link", _extends6({
      key: href,
      rel: "prefetch",
      as: "fetch",
      href
    ...
    if (url.searchParams.get("_routes") !== "") {
      linksToRender = React8.createElement("link", _extends6({
  ...
  return React8.createElement(React8.Fragment, null, linksToRender, moduleHrefs.map((href) => React8.createElement("link", _extends6({
    key: href,
    rel: "modulepreload",
    href
...
@remix-run/react/dist/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-PYCGHMUY.js.map
